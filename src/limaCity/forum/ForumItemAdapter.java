...
public class ForumItemAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null)
			forumListItem = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.forumelementlayout, parent, false);
		else
		...
		String descriptiontext = XmlWorker.htmlToText(forumItems.get(url).getDescription());
		String moderatorstext = forumItems.get(url).getModerators();
		
		TextView name = (TextView) forumListItem.findViewById(R.id.textViewBoardTitle);
		name.setText(nametext);
		TextView description = (TextView) forumListItem.findViewById(R.id.textViewBoardDescription);
		description.setText(descriptiontext);
		TextView moderators = (TextView) forumListItem.findViewById(R.id.textViewBoardModerator);
	...
	private LinearLayout setLayoutOnClick(LinearLayout forumListItem, final String url, final String page)
	{
	...
	public void addFriendItem(String url, String name, String description, String moderators) {
