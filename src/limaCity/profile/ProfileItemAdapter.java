...
public class ProfileItemAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null)
		{
			profileListItem = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.profileelementlayout, parent, false);
		}
		else
		{
		...
		TextView title = (TextView) profileListItem.findViewById(R.id.textViewProfileItemTitle);
		TextView content = (TextView) profileListItem.findViewById(R.id.textViewProfileItemContent);
